    ...
    蜍穂ｽ懊ヶ繝ｩ繧ｦ繧ｶ :: IE4+ , NN4.06+ , Gecko , Opera6+
    ...
    * 證怜捷�･蠕ｩ蜿ｷ蜈ｱ縺ｫ騾｣諠ｳ驟榊�縺ｧ貂｡縺吶％縺ｨ繧ょ�譚･繧�
    // e.g.
    myHash = {
        // Key  : value ( Key 縺ｯ蝗ｺ螳� )
        data    : "Hello !!",
    ...
    * 諡吩ｽ懊� Base64 繝ｩ繧､繝悶Λ繝ｪ繧剃ｽｿ縺� ( 蛻･騾泌ｿ�ｦ� )

    - 證怜捷譁�ｒ隨ｦ蜿ｷ蛹�
    cipherText   = des.encrypt( 逡･.... );
    cipherText64 = base64.encode( cipherText );
    
    - 隨ｦ蜿ｷ蛹悶＆繧後◆證怜捷譁�ｒ蠕ｩ蜿ｷ蛹�
    cipherText = base64.decode( cipherText64 );
    plainText  = des.encrypt( 逡･.... );


    * 諡吩ｽ懊� URL 繧ｨ繝ｳ繧ｳ繝ｼ繝�/繝�さ繝ｼ繝蛾未謨ｰ繧剃ｽｿ縺� ( 蜷後せ繧ｯ繝ｪ繝励ヨ縺ｫ譛峨ｊ )
    ...
    cipherText  ->  證怜捷譁�
    key         ->  繧ｭ繝ｼ [ 8 byte ]
    mode        ->  ecb | cbc | cfb | ofb 縲ら怐逡･譎ゅ� ecb 繝｢繝ｼ繝�
    iv          ->  8 byte (ecb 繝｢繝ｼ繝峨〒縺ｯ荳崎ｦ�)
	salt		->	2 譁�ｭ� [ a-z A-Z 0-9 . / ]
    paddingChar ->  蟷ｳ譁�ｒ8縺ｮ蛟肴焚縺ｫ縺吶ｋ縺溘ａ縺ｫ菴ｿ逕ｨ縺吶ｋ繧ｭ繝｣繝ｩ繧ｯ繧ｿ縲�
    ( pchar )       逵∫払譎ゅ� 0x05縲る壼ｸｸ縺ｯ迚ｹ縺ｫ謖�ｮ壹＠縺ｪ縺�′繝舌う繝翫Μ
                    縺ｮ髫帙�蠢�ｦ√°繧ゅ＠繧後↑縺��( 繝��繧ｿ譛蠕後�繝舌う繝医′
                    0x05 縺ｧ縺ゅ▲縺滓凾縲∝ｾｩ蜿ｷ蛹匁凾繝代ョ繧｣繝ｳ繧ｰ縺輔ｌ縺滓枚蟄励ｒ
                    蜑翫▲縺ｦ霑斐☆髫帙�繝ｭ繧ｰ繝ｩ繝�縺ｯ菴輔ヰ繧､繝亥炎繧後�縺�＞縺九ｒ
                    遏･繧峨↑縺��縺ｧ蜈��繝��繧ｿ縺ｾ縺ｧ蜑翫▲縺ｦ縺励∪縺�√→縺�≧縺薙→ )
    
    
    * 繝舌う繝翫Μ繝｢繝ｼ繝�
    蠖薙Λ繧､繝悶Λ繝ｪ縺ｯ繝�ヵ繧ｩ繝ｫ繝医〒譁�ｭ怜�繧呈桶縺�ｈ縺�↓縺ｪ縺｣縺ｦ縺�∪縺吶�
    繝��繧ｿ縺後ヰ繧､繝翫Μ縺ｮ蝣ｴ蜷医�莠句燕縺ｫ繝｢繝ｼ繝牙､画峩縺励※縺翫￥蠢�ｦ√′縺ゅｊ縺ｾ縺吶�
    ex)
    des.binMode     = 1;
    cipherData      = des.encrypt( 逡･.... );
    
    荳願ｨ倥�讒倥↓證怜捷繝ｻ蠕ｩ蜿ｷ蜑阪↓ des.binMode 縺ｫ逵溘→縺ｪ繧句､繧剃ｻ｣蜈･縺吶ｋ縺薙→縺ｧ
    繝舌う繝翫Μ繝｢繝ｼ繝峨↓縺ｪ繧翫∪縺吶よ枚蟄怜�繝｢繝ｼ繝峨↓謌ｻ縺吶↓縺ｯ
    ex)
    des.binMode     = 0;
    
    蛛ｽ縺ｫ縺ｪ繧句､繧剃ｻ｣蜈･縺励∪縺吶�
...
des = new function()
{
    ...
    //  譛蠕後□縺銑,R 縺悟�繧梧崛繧上ｉ縺ｪ縺��縺ｧ R.concat(L) 縺ｯ豁｣縺励＞
